...
*/
    ...
    @PostMapping("/applied")
    public String applyForCreditCard(String fullName, String email, String address, String city, String state, String zip, int creditLimit) {
        creditCardService.saveCreditCard(fullName, email, address, city, state, zip, creditLimit);
